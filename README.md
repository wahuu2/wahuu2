...
Hotel Management System – Secure booking platform with online payment integration and an admin dashboard for managing reservations, rooms, and customers.

Mobile Repair System – Automated order processing and customer management for a mobile repair shop, featuring real-time status updates and service tracking.

Chemist Website – Localized e-commerce platform for medicines and health products, with inventory management, prescription uploads, and online payments.
...
Expense Tracker App – Full-stack mobile application built with React Native and Express, featuring authentication, income/expense tracking, analytics dashboard, and transaction management.
